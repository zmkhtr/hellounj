...
public class ListPostAdapter extends RecyclerView.Adapter<ListPostAdapter.Viewholder>{
    ...
    public ListPostAdapter(Context mContext) {
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, final int position) {
        ...
        holder.mLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference mRef = FirebaseDatabase.getInstance().getReference("Discussion").child(mDiscussionList.get(position).getId());
                mRef.removeValue();
            }
        });
    }
